...
class _BanksScreenState extends State<BanksScreen> {
            ...
            DropdownButtonFormField<String>(
              ...
              items: banks
                  .map(
                    (b) => DropdownMenuItem(
                      value: b.id,
                      child: Text("${b.name} (Kalan: ${_fmtMoney(b.totalDebt)})"),
                    ),
                  )
                  .toList(),
  ...
  Future<void> _openAddEditDialog({BankDebt? edit}) async {
    ...
    final totalCtrl = TextEditingController(text: edit != null ? edit.totalDebt.toString() : "");
    String minType = edit?.minPaymentType ?? "amount";
    final minCtrl = TextEditingController(text: edit != null ? edit.minPaymentAmount.toString() : "");
    final rateCtrl = TextEditingController(text: edit != null ? edit.interestRate.toString() : "");
    String interestType = edit?.interestType ?? "Monthly";
    final dueDayCtrl =
        TextEditingController(text: edit != null ? edit.paymentDueDay.toString() : "5");
              ...
              child: Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Text(
                        edit == null ? "Banka / Borç Ekle" : "Banka / Borç Düzenle",
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        items: const [
                          DropdownMenuItem(value: "Credit Card", child: Text("Kredi Kartı")),
                          DropdownMenuItem(value: "KMH", child: Text("KMH")),
                          DropdownMenuItem(value: "Overdraft", child: Text("Kredili Mevduat")),
                          DropdownMenuItem(value: "Flexible Account", child: Text("Esnek Hesap")),
                        ],
                        onChanged: (v) => setD(() => debtType = v ?? "Credit Card"),
                      ),
                      const SizedBox(height: 10),
                      TextField(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: DropdownButtonFormField<String>(
                              ...
                              onChanged: (v) => setD(() => minType = v ?? "amount"),
                            ),
                          ),
                        ],
                      ),
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        onChanged: (v) => setD(() => interestType = v ?? "Monthly"),
                      ),
                      const SizedBox(height: 10),
                      TextField(
                      ...
                      Row(
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            child: Text(edit == null ? "Bankayı Kaydet" : "Güncelle"),
                          ),
                        ],
                      )
                    ],
  ...
  Future<void> _confirmDelete(BankDebt d) async {
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text("Bu işlem bankayı ve tüm ödeme geçmişini kaldırır."),
        actions: [
  ...
  Widget build(BuildContext context) {
    ...
    banks.sort((a, b) => b.isActive.toString().compareTo(a.isActive.toString()));
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 4),
                        Text("Kredi kartları, krediler ve ödemeleri yönetin.",
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.trending_down, color: Colors.indigo),
                            ),
                            const SizedBox(width: 10),
                            Expanded(
                              child: Column(
                              ...
                              const Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 4),
                                    Text("Herhangi bir bankaya ekstra ödeme",
              ...
              Expanded(
                child: banks.isEmpty
                    ? Container(
                        ...
                        child: const Center(child: Text("Henüz banka eklenmemiş")),
                      )
                    : GridView.builder(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text("Asgari Ödeme",
                          style: TextStyle(color: Colors.black54, fontSize: 11)),
                      Text(
                        b.minPaymentType == "percentage"
                            ? "%${b.minPaymentAmount}"
                            : _fmtMoney(b.minPaymentAmount),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: const TextStyle(
        ...
        children: [
          Row(
            children: [
              IconButton(
                tooltip: "Düzenle",
                onPressed: () => _openAddEditDialog(edit: b),
              ...
              IconButton(
                ...
                icon: Icon(Icons.delete, size: 20, color: Colors.grey.shade700),
                padding: EdgeInsets.zero,
                constraints: const BoxConstraints(),
              ),
            ],
          ...
          ElevatedButton.icon(
            onPressed: () async {
              await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => BankPlanScreen(bankId: b.id),
                ),
              );
              setState(() {});
            },
